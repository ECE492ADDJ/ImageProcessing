...
class AutoTiltingBallMaze:
	...
	def show_frame(self):
		...
		# By uncommenting this line the image on the GUI will become a videofeed this cannot
		# be run at the same time as calling the videofeed with the masks generated by mazesolver
