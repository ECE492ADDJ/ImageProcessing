...
class MazeNodes:
    ...
    def __init__(self, image):
        ...
        self.filt_large = cv2.getStructuringElement(cv2.MORPH_RECT, (2,2))
    ...
    def findStart(self, start_mask):
        ...
        """
        start_X, start_Y = findRegionCenter(start_mask, self.filt_small, self.filt_large)
    ...
    def findEnd(self, end_mask):
        ...
        """
        end_X, end_Y = findRegionCenter(end_mask, self.filt_small, self.filt_large)
