...
class AutoTiltingBallMaze:
	...
	def __init__(self):
		...
		# Main Gui window to which we add all our elements
		root = Tk()
		...
		# Labels for the Gui such as threshold values, camera index, and serial port
		...
		# Text Fields with default values to save time
	...
	# Function that grabs all the values input by the user and applies them to our main mazesolver code
	def grabVariables(self):
		...
		# Create object of our MazeSolver
		solver = MazeSolver()

		# Set all the values of the object MazeSolver
		...
		# Release the camera for use by the MazeSolver
		self.cap.release()
